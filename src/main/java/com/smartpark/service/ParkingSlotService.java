...
public class ParkingSlotService implements ParkingService {
    ...
    /**
     * Huỷ đặt chỗ — giải phóng slot đã reserve
     */
    ...
    /**
     * Lấy danh sách slot trống (available) theo loại xe
     */
    public List<ParkingSlot> getAvailableSlots(String vehicleType) {
        String zone = "o_to".equals(vehicleType) ? "car" : "motorbike";
        return repo.findByZone(zone).stream()
